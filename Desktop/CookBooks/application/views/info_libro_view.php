		...
		<div id="main">
			<div class="jumbotron">
			  <div class="container">
				<div class='row'>
					<div class='col-md-6'>
						<img class='img-responsive' src='<?=site_url('assets/Image/'.$libro->portada)?>'/>
					</div>
					<div class='col-md-6'>
					...
					<button class="btn btn-default btn-agregar-carrito" role="button" data-id=<?=$libro->id_libro?>>Agregar al carro</button>
					</div>
				</div>
	</div></div></div></div>
</body>
