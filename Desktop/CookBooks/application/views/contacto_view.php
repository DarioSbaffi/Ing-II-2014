	...
	<div class="container">	
		...
		<div id="main">
			<div class="jumbotron">
			   	<div class="container">
			   		<div class="row">
			   			<h2>Para realizar preguntas mas especificas puede recurrir a contactar con el
			   				administrador del sistema al siguiente correo: contacto@cookbooks.com.ar</h2>
			   		</div>				
			    </div>
			</div>
		</div>
