					...
					<div class="row">
						...
						<fieldset>
							...
							<div class="form-group">
								...
								value="<?=$fila->nom?>" class="form-control">
							...
							<div class="form-group">
								...
								value="<?=$fila->apellido?>" class="form-control">
							...
							<div class="form-group">
								...
								value="<?=$fila->telefono?>" class="form-control">
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<select id="reg_ciudad" name="reg_ciudad">
									<option value="<?=$fila->idciudad?>" selected="selected"><?=$fila->nom_ciudad?></option>
								</select>
							...
							value="<?=$fila->calle?>">
							<?=form_error('reg_calle','<div class="alert alert-danger">','</div>')?></div>
