...
$lang['valid_emails']		= "El campo %s debe contener correos electronicos válidos.";
...
$lang['alpha_numeric']		= "El campo %s solo puede contener caracteres alfa-numéricos.";
$lang['alpha_dash']			= "El campo %s solo puede contener caracteresalfa-numéricos, guiones bajos, y guiones.";
$lang['numeric']			= "El campo %s solo debe contener números.";
...
$lang['matches']			= "El campo %s no cincide con el campo %s.";
$lang['is_unique'] 			= "El campo %s debe contener un valor único.";
$lang['is_natural']			= "El campo %s solo debe contener números positivos.";
