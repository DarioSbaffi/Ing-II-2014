...
?>
    ...
    <!----------cargamos las nuevas entradas del formulario de arriba-------->
...
$show_messages = $nuevo->messages($_SESSION['id']);
    ...
    //conseguimos la id que nos dirá cuáles son los comentarios para cada mensaje
        $id=$message['id'];
    ...
    ?>
        ...
        <!--------------------aquí mostramos los formularios--------------------------->
        ...
        if(!empty($comments))
        {
           ...
           <!----------aquí mostramos los comentarios de los mensajes---------------->
