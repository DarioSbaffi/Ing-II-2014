...
$(document).ready(function(){
	var caja = $('#editorial_input_box');
	caja.append('<input id="nueva-cat" type="button" value="Nueva" class="btn">');
	caja.append('<div id="div-agregar"><p>Nueva Editorial:</p><input type="text"><input id="agregar-cat" type="button" value="Agregar" class="btn"></div>');
